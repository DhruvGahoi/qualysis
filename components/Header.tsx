...
export default function Header() {
  return (
    ...
    <header className="px-6 sticky top-0 border-b transition duration-200 ease-in-out border-white/10 bg-black/[0.96] backdrop-blur-[0.5px] animate-header-slide-down-fade">
